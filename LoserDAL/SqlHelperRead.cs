...
namespace LoserDAL
{
    public abstract class SqlHelperRead
    {
        public static readonly string ConnectionString = Config.ConnectionStringRead;
        ...
        public static object ExecuteScalar(string cmdText, SqlParameter[] patas)
        {
            ...
            return ExecuteScalar(SqlHelperRead.ConnectionString, CommandType.Text, cmd);
        }
        ...
        {
            return ExecuteScalar(SqlHelperRead.ConnectionString, type, cmd);
        }
        ...
        public static int ExecuteNonQuery(string cmdText)
        {
            ...
            cmd.CommandText = cmdText;
            cmd.CommandTimeout = Default_Timeout_Value;
            return ExecuteNonQuery(SqlHelperRead.ConnectionString, CommandType.Text, cmd);
        }
        ...
        {
            return ExecuteNonQuery(SqlHelperRead.ConnectionString, CommandType.Text, cmd, out sysno);
        }
        ...
        {
            return ExecuteNonQuery(SqlHelperRead.ConnectionString, cmdType, cmd);
        }
        public static int ExecuteNonQuery(string connectionString, CommandType cmdType, SqlCommand cmd, out int sysno)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                if (cmd.Parameters.Contains("@SysNo") && cmd.Parameters["@SysNo"].Direction == ParameterDirection.Output)
                    ...
                    throw new Exception("SqlHelperRead: Does not contain SysNo or ParameterDirection is Not Output");
                cmd.Parameters.Clear();
                return rowsAffected;
            }
        }
        ...
        {
            return ExecuteDataSet(SqlHelperRead.ConnectionString, cmdText, null);
        }
        ...
        {
            return ExecuteDataSet(SqlHelperRead.ConnectionString, cmdText, paras);
        }
        ...
        {
            using (SqlConnection conn = new SqlConnection(SqlHelperRead.ConnectionString))
            {
                if (conn.State != ConnectionState.Open)
                    conn.Open();
                cmd.Connection = conn;
        ...
        public static bool IsHasGuid(string tablename, Guid synid)
        {
            ...
            int retint = Convert.ToInt32(SqlHelperRead.ExecuteScalar(sql));
            return retint > 0;
        }
    }
}
